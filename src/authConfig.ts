...
export const providerConfig: Configuration = {
  ...
  cache: {
    ...
    // TLDR: Microsoft considers local storage as secure as session storage for storing tokens, both need to beware of XSS
 ...
 *
 * Additional scopes can be requested when obtaining an access token. For more information, visit:
